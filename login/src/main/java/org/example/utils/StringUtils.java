...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static <T> T[] split(String str, String separator, Class<T> clazz) {
        if (isBlank(str)) {
        ...
        if (clazz == String.class) {
            ...
            return (T[]) list.stream().map(Long::valueOf).toArray(Long[]::new);
        } else if (clazz == Integer.class) {
            return (T[]) list.stream().map(Integer::valueOf).toArray(Integer[]::new);
        }
