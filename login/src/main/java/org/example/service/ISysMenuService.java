...
public interface ISysMenuService {
     ...
     * @return 菜单列表
     */
    List<SimpleMenuVo> selectMenuList(SysMenuBo menu, Long userId);
     ...
     * @return 分页结果
     */
    Map<String, Object> selectMenuListWithPage(SysMenuBo menu, Long userId);
     ...
     * @return 路由列表
     */
    List<org.example.domain.vo.RouterVo> buildMenus(List<SysMenu> menus);
     ...
     * @return 下拉树结构列表
     */
    List<Object> buildMenuTreeSelect(List<SysMenuVo> menus);
